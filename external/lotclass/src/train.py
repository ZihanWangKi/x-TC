...
# mainly add some hyperparameters (e.g., random_state, lm_type) over
# the original version, and split the train and inference stage.
...
def main():
    ...
    parser.add_argument('--self_train_epochs', type=int, default=1,
    ...
    parser.add_argument('--lm_type', default="bert-base-uncased", type=str)
