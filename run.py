...
parser.add_argument('--label_names_file_name', type=str, default='label_names.txt', help='file name of label names') # we can add the variants.
parser.add_argument('--prompt_file_name', type=str, default='prompt.txt', help='file name of prompt')
...
# dataset loading
train_dataset, train_label, test_dataset, test_label = data_process(args.data) # TODO add args.label_names_file_name, args.prompt_file_name
