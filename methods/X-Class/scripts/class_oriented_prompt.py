...
from static_representations_prompt import handle_sentence
from utils import (INTERMEDIATE_DATA_FOLDER_PATH, MODELS, DATA_FOLDER_PATH,
...
def weight_sentence(model,
    ...
    document_representation = weight_sentence_with_attention(vocab, tokenized_text, contextualized_word_representations,
                                                             class_representations, attention_mechanism, l, r)
