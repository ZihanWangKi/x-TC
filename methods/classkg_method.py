...
class classkg():
    def __init__(self, hyperparams: classkgHyperparams, base_model):
        ...
        self.exp_name = os.path.join(retval, "experiment", "classkg", exp)
    ...
    def apply(self, dataset_name, train_dataset: Dataset, train_label: Labels):
        dataset_path = os.path.join(self.exp_name, "data", "processed", dataset_name)
        ...
        os.system(f"mkdir -p {self.exp_name}/config")
        with open(f"{self.exp_name}/config/{dataset_name}.yaml", "w") as f:
    ...
    def inference(self, dataset_name, test_dataset: Dataset):
        inference_path = os.path.join(self.exp_name, "data", "processed", dataset_name)
