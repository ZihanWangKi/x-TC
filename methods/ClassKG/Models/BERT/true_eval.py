...
class True_Eval_Model_For_BERT():
    ...
    def __call__(self, model):
        ...
        self.logger.info('Test set ACC:{}'.format(acc))
        self.logger.info('Test set f1_macro:{}'.format(f1_macro))
        self.logger.info('Test set f1_micro:{}'.format(f1_micro))
