...
taskset -c 30-60 python run.py  --dataset NYT-Topics --class_names_file ./default_class_names/nyt-top.txt --split_ratio 0.8 --class_names --train_size 0.2 --test_size 1 --gpu ${gpu} --suffix "64 bbu 12 bbc 128 mixture none"
taskset -c 30-60 python run.py  --dataset NYT-Locations --class_names_file ./default_class_names/nyt-loc.txt --split_ratio 0.8 --class_names --train_size 0.2 --test_size 1 --gpu ${gpu} --suffix "64 bbu 12 bbc 128 mixture none"
