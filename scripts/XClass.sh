...
taskset -c 30-60 python run.py  --dataset 20News --class_names_file ./default_class_names/20.txt --prompt_file ./prompts/topic.txt --split_ratio 0.7 --class_names --train_size 0.5 --test_size 1 --gpu ${gpu} --suffix "64 bbu 12 bbc 128 mixture 0 tied"
taskset -c 30-60 python run.py  --dataset 20News --class_names_file ./default_class_names/20.txt --prompt_file ./prompts/topic.txt --split_ratio 0.7 --class_names --train_size 0.5 --test_size 1 --gpu ${gpu} --suffix "100 blu 24 blc 128 mixture 0 tied"
