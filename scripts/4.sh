...
MASTER_PORT=18677 taskset -c 90-120 python run.py  --method ClassKG --class_names_file ./default_class_names/ag.txt --split_ratio 0.7 --class_names --train_size 0.05 --test_size 1 --gpu ${gpu} --suffix "--lm roberta-base"
MASTER_PORT=18677 taskset -c 90-120 python run.py  --method ClassKG --class_names_file ./default_class_names/ag.txt --split_ratio 0.7 --class_names --train_size 0.05 --test_size 1 --gpu ${gpu} --suffix "--lm roberta-large"

MASTER_PORT=18677 taskset -c 90-120 python run.py  --method ClassKG --dataset NYT-Locations --class_names_file ./default_class_names/nyt-loc.txt --split_ratio 0.8 --class_names --train_size 0.2 --test_size 1 --gpu ${gpu} --suffix "--lm roberta-base"
MASTER_PORT=18677 taskset -c 90-120 python run.py  --method ClassKG --dataset NYT-Locations --class_names_file ./default_class_names/nyt-loc.txt --split_ratio 0.8 --class_names --train_size 0.2 --test_size 1 --gpu ${gpu} --suffix "--lm roberta-large"
